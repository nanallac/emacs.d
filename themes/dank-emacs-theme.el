...
(let* ((bg "#101418")
      (err "#ff3270")  ; Red from dank16
      (err-container "#8c1d18")
      (on-background "#e0e2e8")
      (on-err "#601410")
      (on-err-container "#f9dedc")
      (on-primary "#000000")
      (on-primary-container "#e0e2e8")
      (on-secondary "#000000")
      (on-secondary-container "#e0e2e8")
      (on-surface "#e0e2e8")
      (on-surface-variant "#c2c7cf")
      (on-tertiary "#000000")
      (on-tertiary-container "#e0e2e8")
      (outline-color "#8c9199")
      (outline-variant "#42474e")
      (primary "#42a5f5")
      (primary-container "#0d47a1")
      (secondary "#8ab4f8")
      (secondary-container "#272a2f")
      (shadow "#000000")
      (surface "#101418")
      (surface-container "#272a2f")
      (surface-container-high "#32353a")
      (surface-container-highest "#272a2f")
      (surface-container-low "#101418")
      (surface-container-lowest "#101418")
      (surface-variant "#42474e")
      (tertiary "#8ab4f8")
      (tertiary-container "#272a2f")

      ;; Enhanced dank16 colors for better syntax highlighting
      (dank-red "#ff3270")          ; Bright red
      (dank-red-alt "#ff739e")      ; Alternative red
      (dank-green "#42f558")        ; Vibrant green
      (dank-green-bright "#7cff8d") ; Bright green
      (dank-yellow "#fff332")       ; Warm yellow
      (dank-yellow-bright "#fff77c") ; Bright yellow
      (dank-blue "#1c8de8")         ; Blue-green
      (dank-magenta "#003e71")      ; Teal-magenta
      (dank-cyan "#42a5f5")         ; Bright cyan
      (dank-cyan-bright "#60b8ff") ; Brightest cyan
      (dank-cyan-dark "#7cc4ff")   ; Dark cyan
      (dank-teal "#abd9ff")        ; Dark teal
      (dank-fg "#e8f4ff")           ; Light foreground
      (dank-gray "#8d979f")         ; Gray
      (dank-white "#f5faff")       ; White

      ;; Map success colors to green
      (success "#42f558")
      (on-success "#000000")
      (success-container "#272a2f")
      (on-success-container "#e0e2e8")

      ;; Map fixed colors
      (primary-fixed "#0d47a1")
      (primary-fixed-dim "#42a5f5")
      (secondary-fixed "#8ab4f8")
      (secondary-fixed-dim "#8ab4f8")
      (tertiary-fixed "#8ab4f8")
      (tertiary-fixed-dim "#8ab4f8")
